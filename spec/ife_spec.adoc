...
// Draft marking: -a draft until the document is ratified. Deliberately a
// visible admonition rather than a theme watermark, so it survives every
// backend rather than only the PDF one.
include::{generated}/provenance.adoc[]
